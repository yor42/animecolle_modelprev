...
import yor42.animearsenal.proxy.clientProxy;
...
public class main {
    ...
    @SidedProxy(clientSide = "yor42.animearsenal.proxy.clientProxy")
    ...
    public static void addModels(ModelRegistryEvent event){
        for(Item item: ItemInit.ITEM_LIST){
            Clientproxy.registerItemRenderer(item, 0, "inventory");
        }
    }
